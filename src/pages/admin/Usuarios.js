                        ...
                        <div className='bg-white'>
                            <div className='row'>
                                <div className='col-md-12 title-page'>
                                    ...
                                    <button className='btn-new' onClick={(openUser)}>
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>sara@test.com</td>
                                        <td>
                                            <button className='btnEdit' onClick={(openUser)}>
                                            ...
                                            <button className='btnDelete' onClick={(deleteUser)} data-href="1">
            ...
            <div id="newMov" className='new'>
                ...
                <form>
                    ...
                    <div className='form-group'>
                        ...
                        <input type="email" nome="email" id='email' className='form-control' required/>
                    </div>
                    <div className='form-group'>
